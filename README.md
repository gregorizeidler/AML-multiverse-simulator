...
All screenshots taken from a running instance with 300 customers · 3,197 transactions · 7 universes.

### Overview Dashboard
![Overview](docs/screenshots/screenshot_01_overview.png)

### Parallel Universes — Recall vs FPR + Rankings
![Universes](docs/screenshots/screenshot_02_universes.png)

### Universe Detail — ML Model Universe (F1=0.909 · Recall=99.5% · AUC-ROC=0.996)
![Universe Detail](docs/screenshots/screenshot_03_universe_detail.png)

### Transaction Network Graph — D3 Force-Directed (136 accounts · 150 flows · 20 suspicious)
![Network Graph](docs/screenshots/screenshot_04_network_graph.png)

### Pareto Frontier — 2 Non-Dominated Universes out of 7
![Pareto Frontier](docs/screenshots/screenshot_05_pareto.png)

### Failure Autopsy — False Negatives & False Positives by Typology
![Autopsy](docs/screenshots/screenshot_06_autopsy.png)

### SAR Reports — 35 Auto-Generated Reports · $115M Suspicious Amount
![SAR Reports](docs/screenshots/screenshot_08_sar.png)

### Case Management — DBSCAN Alert Clustering
![Case Management](docs/screenshots/screenshot_07_cases.png)

### Policy Recommendations — AI-Driven Deployment Guidance
![Recommendations](docs/screenshots/screenshot_09_recommendations.png)

### Entity Resolution — Union-Find · 300 Entities · 87 Multi-Account
![Entity Resolution](docs/screenshots/screenshot_10_entity_resolution.png)

### SHAP Explainability — Global Feature Importance (TreeExplainer · 500 samples)
![SHAP Explainer](docs/screenshots/screenshot_11_shap.png)

### Concept Drift Monitor — KS Test + PSI (10 features · drift score 0.0426)
![Drift Monitor](docs/screenshots/screenshot_12_drift.png)

### Threshold Simulator — Interactive Rule Tuning
![Threshold Simulator](docs/screenshots/screenshot_13_thresholds.png)

### Live Simulation Stream — WebSocket Real-Time Feed
![Live Stream](docs/screenshots/screenshot_16_live_stream.png)

### AI Chat (RAG) — Context-Aware LLM over Simulation Results
![AI Chat](docs/screenshots/screenshot_15_chat.png)
